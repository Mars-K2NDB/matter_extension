...
{
    LightColorMode color_mode = LightColorMode::kCt;
...
/** Write Matter color/level attributes from cache; forces OnOff off. */
...
void UpdateLightStateFromAttributeChange(chip::EndpointId endpoint, chip::ClusterId cluster_id,
