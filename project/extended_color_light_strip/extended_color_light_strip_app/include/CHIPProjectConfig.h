...
// Mains-powered FTD Thread: disable ICD and defer Thread autostart until device type is configured.
...
// Color-temperature transitions can post many OnOff/Level events; avoid queue overflow.
