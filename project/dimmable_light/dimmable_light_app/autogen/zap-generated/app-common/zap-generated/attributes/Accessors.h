...
Protocols::InteractionModel::Status Get(EndpointId endpoint, chip::app::Clusters::WaterTankLevelMonitoring::DegradationDirectionEnum * value); // DegradationDirectionEnum
Protocols::InteractionModel::Status Set(EndpointId endpoint, chip::app::Clusters::WaterTankLevelMonitoring::DegradationDirectionEnum value);
Protocols::InteractionModel::Status Set(EndpointId endpoint, chip::app::Clusters::WaterTankLevelMonitoring::DegradationDirectionEnum value, MarkAttributeDirty markDirty);
} // namespace DegradationDirection

namespace ChangeIndication {
Protocols::InteractionModel::Status Get(EndpointId endpoint, chip::app::Clusters::WaterTankLevelMonitoring::ChangeIndicationEnum * value); // ChangeIndicationEnum
Protocols::InteractionModel::Status Set(EndpointId endpoint, chip::app::Clusters::WaterTankLevelMonitoring::ChangeIndicationEnum value);
Protocols::InteractionModel::Status Set(EndpointId endpoint, chip::app::Clusters::WaterTankLevelMonitoring::ChangeIndicationEnum value, MarkAttributeDirty markDirty);
} // namespace ChangeIndication
...
Protocols::InteractionModel::Status Get(EndpointId endpoint, chip::app::Clusters::Humidistat::SystemStateEnum * value); // SystemStateEnum
...
namespace MistType {
Protocols::InteractionModel::Status Get(EndpointId endpoint, chip::BitMask<chip::app::Clusters::Humidistat::MistTypeBitmap> * value); // MistTypeBitmap
...
Protocols::InteractionModel::Status Get(EndpointId endpoint, chip::app::Clusters::ProximityRanging::BLTCSSecurityLevelEnum * value); // BLTCSSecurityLevelEnum
...
Protocols::InteractionModel::Status Get(EndpointId endpoint, chip::app::Clusters::ProximityRanging::BLTCSModeEnum * value); // BLTCSModeEnum
