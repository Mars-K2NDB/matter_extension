...
// clang-format off
#define GENERATED_EVENT_COUNT 31
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 18, 16 }, \
  { ZAP_CLUSTER_INDEX(18), 3, 6 }, \
  { ZAP_CLUSTER_INDEX(21), 3, 6 }, \
  { ZAP_CLUSTER_INDEX(24), 3, 6 }, \
  { ZAP_CLUSTER_INDEX(27), 3, 6 }, \
}
