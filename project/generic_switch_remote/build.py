#!/usr/bin/env python3
"""Generic Switch 工程编译：SLC generate → codegen 补丁 → 编译。"""
...
SLCW = PROJECT_DIR / "matter_thread_soc_generic_switch_remote_app_series_2_internal_freertos.slcw"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="编译 Generic Switch 遥控器工程。")
    parser.add_argument(
        "-b",
        "--silabs_board",
        default="brd2703a",
