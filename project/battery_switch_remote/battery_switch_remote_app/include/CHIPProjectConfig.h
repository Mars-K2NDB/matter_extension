...
// BATTERY_SWITCH_ICD_CONFIG
// 电池供电 ICD：Thread MTD/SED + ICD Management / Time Synchronization
...
// 已配网且 Thread 入网后熄灭 LED0（PA04）
#ifndef MATTER_STATUS_LED_OFF_WHEN_ATTACHED
#define MATTER_STATUS_LED_OFF_WHEN_ATTACHED 1
#endif
