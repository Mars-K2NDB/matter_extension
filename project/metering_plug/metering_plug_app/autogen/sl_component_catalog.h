...
#define SL_CATALOG_MATTER_ELECTRICAL_ENERGY_MEASUREMENT_PRESENT
#define SL_CATALOG_MATTER_ELECTRICAL_POWER_MEASUREMENT_PRESENT
...
#define SL_CATALOG_MATTER_POWER_TOPOLOGY_PRESENT
